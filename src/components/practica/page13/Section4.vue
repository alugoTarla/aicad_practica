...
export default {
  ...
  data() {
    return {
      ...
      , p13s1Urlrss: "https://www.googleapis.com/youtube/v3/search"
      + "?part=id"
  ...
  methods: {
    ...
    buscarVideos: async function(){
      ...
      .catch( error => {
        console.log(error);
        this.p13s1Ids = [
        "qwg-G75eu7s","SYp0ipioV00","wyRZS84qFtM","75NNhc-6ce0","mT9tRhivkQ8","gkIs4Af6y-I","DiO2q6GgW7s",
        "AMd6f6dbGd8","3LRusFpClek","Uu0E2wbeA9Y","Q3f5Hv6dzog","pEa1Yzhw82Y","89W0Vrwl0t8","udpxArsBiQg",
        "T2bGz5vsX9E","lZYHi-6ebus","fCCMjwPwp4c","xwrzqThkFFc","p0Zmp0favkg","kpFn9hx6pVc","asopZmlhmCA",
        "6EwWA86yrG8","P8AjejrSHpM","IGjT19NU50Q","Snv8MuR-jYU","Qj-SIdkC7Bg","nlu4_RiEtCw","NZufl5IYgP8",
        "WOMXwF8WimI","BbfvY7GwrVc" ];
      });
      var obj = JSON.parse(JSON.stringify(result));
      for (let index = 0; index < obj.items.length; index++) {
        const element = obj.items[index].id.videoId;
