...
<i18n>
{
  "en":{
    "p17s4titles": [
      {
        "titleS": false
        , "title": "Find below some of our partner universities"
      }
    ]
  },
  "es":{
    "p17s4titles": [
      {
        "titleS": false
        , "title": "Aquí tienes algunas universidades amigas"
      }
    ]
  }
}
...
<script>
import tUnis from "@/components/utils/temp_uni";
export default {
  components: {
    tUnis
  },
